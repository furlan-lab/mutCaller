...
### Updates
- **version 0.8.0** 7/21/24 - added a new feature that counds variants when no MD tag is present in BAM (such as those output by cellranger) - currently only SNVs are allowed in this mode. Added a function to check variants file against a reference genome
